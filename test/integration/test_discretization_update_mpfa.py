...
from test.integration.setup_mixed_dimensional_grids import set_bc_flow, update_apertures
...
class BasicsTest(unittest.TestCase):
    ...
    def test_discretization_and_propagation_2d(self):
        ...
        physics = "flow"
        n_cells = [4, 4]
        gb_1 = setup_gb.setup_flow(n_cells, 0.75)
        gb_2 = setup_gb.setup_flow(n_cells, 0.25)
        gb_3 = setup_gb.setup_flow(n_cells, 0.50)
        gb_4 = setup_gb.setup_flow(n_cells, 0.25)
        ...
        lhs_2, rhs_2 = propagate_and_update(
            gb_2, [29, 30], flux_discr, set_bc_flow, update_apertures
        )
        lhs_3, rhs_3 = propagate_and_update(
            gb_3, [30], flux_discr, set_bc_flow, update_apertures
        )
        lhs_4, rhs_4 = propagate_and_update(
            gb_4, [29], flux_discr, set_bc_flow, update_apertures
        )
        lhs_4, rhs_4 = propagate_and_update(
            gb_4, [30], flux_discr, set_bc_flow, update_apertures
        )
    ...
    def test_discretization_and_propagation_3d(self):
        ...
        # Propagate and update discretizations
        lhs_2, rhs_2 = propagate_and_update(
            gb_2, [193, 194, 197, 198], flux_discr, set_bc_flow, update_apertures
        )
        lhs_3, rhs_3 = propagate_and_update(
            gb_3, [194, 198], flux_discr, set_bc_flow, update_apertures
        )
        lhs_4, rhs_4 = propagate_and_update(
            gb_4, [193], flux_discr, set_bc_flow, update_apertures
        )
        lhs_4, rhs_4 = propagate_and_update(
            gb_4, [194, 197, 198], flux_discr, set_bc_flow, update_apertures
        )
