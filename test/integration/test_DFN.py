...
class TestDFN(unittest.TestCase):
    def test_mvem_0(self):
        ...
        A_f1 = np.matrix([[0.75, 0.  , 0.  ,-0.25, 1, 0],
                          [0.  , 0.75, 0.  , 0.  , 0, 0],
                          [0.  ,-0.25, 0.75, 0.  , 0,-1],
                          [0.  , 0.  , 0.  , 0.75, 0, 0],
                          [1.  , 0.  , 0.  ,-1.  , 0, 0],
        ...
        A_f2 = np.matrix([[0.75, 0.  , 0.  ,-0.25,1, 0],
                          [0.  , 0.75, 0.  , 0.  ,0, 0],
                          [0.  ,-0.25, 0.75, 0.  ,0,-1],
                          [0.  , 0.  , 0.  , 0.75,0, 0],
                          [1.  , 0.  , 0.  ,-1.  ,0, 0],
        ...
        A_e1_e_gh = np.matrix([[0.  , 0.75,-0.25, 0.  , 0, 1],
                               [0.25, 0.  , 0.  ,-0.75, 1, 0]])

        A_e1_gh_gl = np.matrix([[0.], [0.], [0.], [0.], [0.], [0.]])
        A_e1_gl_gh = np.matrix([[0., 0., 0., 0., 0., 0.]])

        A_e1_e_e = np.matrix([[-0.75,  0.  ],
                              [ 0.  , -0.75]])

        A_e1_e_gl = np.matrix([[-1.], [-1.]])
        A_e1_gl_e = np.matrix([[-1., -1.]])

        b_e1 = np.array([0., 0.])

        A_e2_gh_e = np.matrix([[ 0.  ,-0.25],
                               [ 0.  ,0.   ],
                               [ 0.25,0.   ],
                               [ 0.  ,0.   ],
                               [ 0.  ,-1.  ],
        ...
        A_e2_e_gh = np.matrix([[ 0.  ,  0.75, -0.25,  0.  ,  0.  ,  1.  ],
                               [ 0.25,  0.  ,  0.  , -0.75,  1.  ,  0.  ]])

        A_e2_gh_gl = np.matrix([[0.], [0.], [0.], [0.], [0.], [0.]])
        A_e2_gl_gh = np.matrix([[0., 0., 0., 0., 0., 0.]])

        A_e2_e_e = np.matrix([[-0.75,  0.  ],
                              [ 0.  , -0.75]])

        A_e2_e_gl = np.matrix([[-1.], [-1.]])
        A_e2_gl_e = np.matrix([[-1., -1.]])
    ...
    def test_tpfa_0(self):
        ...
        # known matrices associate to the edge where f1 is involved
        A_e1_gh_e = np.matrix([[0, 1],
                               [1, 0]])

        A_e1_e_gh = np.matrix([[0, 1],
                               [1, 0]])

        A_e1_gh_gl = np.matrix([[0.], [0.]])
        A_e1_gl_gh = np.matrix([[0., 0.]])

        A_e1_e_e = np.matrix([[-0.5,  0. ],
                              [ 0. , -0.5]])
        ...
        A_e2_gh_e = np.matrix([[0, 1],
                               [1, 0]])

        A_e2_e_gh = np.matrix([[0, 1],
                               [1, 0]])

        A_e2_gh_gl = np.matrix([[0.], [0.]])
        A_e2_gl_gh = np.matrix([[0., 0.]])

        A_e2_e_e = np.matrix([[-0.5,  0. ],
                              [ 0. , -0.5]])
