...
class TestCCW(unittest.TestCase):
    ...
    def test_tolerance(self):
        ...
        self.assertTrue(pp.geometry_property_checks.is_ccw_polyline(p1, p2, p3, tol=1e-4, default=True))

        # Default kills us, even though we're inside safety margin
        self.assertTrue(not pp.geometry_property_checks.is_ccw_polyline(p1, p2, p3, tol=1e-4, default=False))

        # Outside safety margin, and on the ccw side
        self.assertTrue(pp.geometry_property_checks.is_ccw_polyline(p1, p2, p3, tol=1e-8, default=False))
    ...
    def test_tolerance_outside(self):
        ...
        self.assertTrue(not pp.geometry_property_checks.is_ccw_polyline(p1, p2, p3, tol=1e-8, default=False))
