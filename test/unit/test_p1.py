...
#------------------------------------------------------------------------------#
    ...
    def test_p1_2d_iso_simplex(self):
        ...
        M_known = np.matrix([[ 1.  ,  0.25,  0.25,  0.5 ],
                             [ 0.25,  0.5 ,  0.  ,  0.25],
                             [ 0.25,  0.  ,  0.5 ,  0.25],
                             [ 0.5 ,  0.25,  0.25,  1.  ]])/6.
...
#------------------------------------------------------------------------------#
    ...
    def test_p1_3d(self):
        ...
        M_known = np.matrix([[ 1. ,  0.5,  0.5,  0. ,  0.5,  0. ,  0. ,  0. ],
...
#------------------------------------------------------------------------------#
    ...
    def test_p1_convergence_1d_not_exact(self):
        ...
        known_errors = [0.0739720694066, 0.0285777089832, 0.00791150843359,
                       0.00202828006648, 0.00051026002257, 0.000127765008718,
                       3.19537621983e-05]
