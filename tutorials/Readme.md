...
14. [Stress discretization](./stress_discretization.ipynb) describes the discretization method used for the vector equations. It arises in the stress-strain relationship of Hooke's law.