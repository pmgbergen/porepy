...
•	Robust numerical methods that allows for simulation of non-linearly coupled multiphysics processes.
•	Ready-made simulation setups for coupled processes, including:
    o	Thermo-poromechanics coupled with fracture deformation.
    o	Multiphase flow and transport.
    The code is focused on easy adaptation of these setups to allow for rapid prototyping.
...
•	If you have a GitHub account, PorePy can be run in the web browser through a GitHub codespace for PorePy following [these instructions]( https://docs.github.com/en/codespaces/developing-in-a-codespace/creating-a-codespace-for-a-repository#creating-a-codespace-for-a-repository).
