...
class TestTpsaTailoredGrid:
    ...
    def test_neumann_bcs(self):
        ...
        # Transform the stress components to rotations via an inverse Hook's law. Sign
        # change on the first row, compared to the second, since the normal vector
        # points into that cell.
        bound_rotation_displacement = np.zeros((2, 14))
        ...
        # Sign change on the first row, compared to the second, since the normal vector
        # points into that cell.
        bound_mass_displacement = np.zeros((2, 14))
    ...
    def test_robin_bcs(self):
        ...
        # displacement part. Sign change on the first term of the first row (Neumann
        # term, not Dirichlet one), since the normal vector points into this cell.
        bound_rotation_displacement = np.zeros((2, 14))
    ...
    def test_mixed_bcs(self):
        ...
        bound_rotation_displacement = np.zeros((2, 14))
        # From the definition of \bar{R}, we get [-n[1], n[0]]. The discretization is
        # -\bar{R}, hence the sign change. Also sign change on the first row, since the
        # normal vector points into this cell.
