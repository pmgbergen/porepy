...
def test_schur_complement_empty_equation_filter():
    """Test that equations defined on empty domains are ignored by the
    Schur complement assembly pipeline."""
    ...
    # Create variable on empty domain.
    ...
    S, bS = equation_system.assemble_schur_complement_system(
        primary_equations=["eq_all_subdomains", "empty_equation"],
        primary_variables=["x", "empty_var"],
        inverter=inverter,
    )
