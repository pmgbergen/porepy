...
class SolutionStrategyPressureMassTest(test_hu_model.SolutionStrategyPressureMass):
    ...
    def after_nonlinear_iteration(self, solution_vector: np.ndarray) -> None:
        ...
        #         print(i)
        #     pdb.set_trace()
        # # face 12 cell 4 and -1 (boundary) 
        # # face 17 cell 1 and -1
        # # => 12 is upper face, 17 is lower face
        ...
        # flux_intf_phase_0_p = flux_intf_phase_0_p.evaluate(self.equation_system).val[[12,17]] 
        # flux_intf_phase_1_p = flux_intf_phase_1_p.evaluate(self.equation_system).val[[12,17]]
        ...
        # flux_intf_phase_0_m = flux_intf_phase_0_m.evaluate(self.equation_system).val[[12,17]]
        # flux_intf_phase_1_m = flux_intf_phase_1_m.evaluate(self.equation_system).val[[12,17]]
...
class MyModelGeometryTest(pp.ModelGeometry):
    ...
    def set_fractures(self) -> None:
        """ """
        frac1 = pp.LineFracture( np.array([[1., 2], [1, 1]]) )
