...
"""
same regime of 1. geometry scaled. viscosity scaled to keep regime constant. this works
"""
...
class SolutionStrategyPressureMass_1(test_hu_model.SolutionStrategyPressureMass):
    ...
    def intrinsic_permeability(self, subdomains):
        ...
        for sd in subdomains:
            permeability = 1e-4 * np.ones(sd.num_cells) * darcy_to_m2 # bottom # 100 mD
...
class FinalModel(PartialFinalModel):  
    def __init__(self, mixture, params: Optional[dict] = None):
        ...
        self.dynamic_viscosity = 50*1e-1 # 1e-3 [kg / (m*s)] water        
        self.xmax = 1
        self.ymax = 1
