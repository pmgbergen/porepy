...
"""
- permeable: k = 10 NO, blocking: k = 0.1 YES
-
"""
...
class SolutionStrategyTest1(two_phase_hu.SolutionStrategyPressureMass):
    def prepare_simulation(self) -> None:
        ...
        pp.plot_grid(sd, vector_value=0.5 * sd.face_normals, alpha=0, info="f")
...
if __name__ == "__main__":
    ...
    class FinalModel(PartialFinalModel):
        def __init__(self, params: Optional[dict] = None):
            ...
            self.root_path = "./case_1/horizontal_hu_beta/"
    ...
    os.system("mkdir -p ./case_1/horizontal_hu_beta")
    os.system("mkdir -p ./case_1/horizontal_hu_beta/BETA")
    folder_name = "./case_1/horizontal_hu_beta/" + "visualization"

    time_manager = two_phase_hu.TimeManagerPP(
        schedule=np.array([0, 2e-1]) / t_0,
        dt_init=1e-1 / t_0,
