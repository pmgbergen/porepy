...
class ContactMechanicsEquations(pp.BalanceEquation):
    ...
    def set_equations(self) -> None:
        ...
        self.equation_system.set_equation(
            fracture_eq_normal,
            pp.DefaultEquationTags.normal_fracture_deformation,
            fracture_subdomains,
            {"cells": 1},
        )
        self.equation_system.set_equation(
            fracture_eq_tangential,
            pp.DefaultEquationTags.tangential_fracture_deformation,
            fracture_subdomains,
            {"cells": self.nd - 1},
        )
...
class ContactTractionVariable(VariableMixin):
    ...
    def create_variables(self) -> None:
        ...
        self.equation_system.create_variables(
            ...
            var_tag=pp.DefaultVariableTags.contact_traction,
