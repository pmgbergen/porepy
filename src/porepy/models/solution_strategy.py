...
class ReferenceStateInitialization:
    """Update the reference state at the beginning of the simulation."""

    def prepare_simulation(self) -> None:
        """Include initialization of the reference state in the preparation of the simulation."""
        ...
        while True:
            ...
            # Communicate dt to the model and update time-dependent arrays and derived quantities.
            self.before_time_step()

            # TODO: self.initialize_nonlinear_solution()
        ...
        # Save initial data.
        # TODO need to overwrite current!
        self.save_data_time_step()
    ...
    def check_initialization_convergence(self) -> ConvergenceStatus:
        ...
        Returns:
            ConvergenceStatus: Enum indicating whether the initialization state is converged
            or not.
