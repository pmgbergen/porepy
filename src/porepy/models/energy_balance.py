...
class TotalEnergyBalanceEquations(pp.BalanceEquation):
    ...
    def set_equations(self) -> None:
        ...
        self.equation_system.set_equation(
            sd_eq, subdomains, {"cells": 1}, is_nonlinear=True
        )
        self.equation_system.set_equation(
            intf_cond, codim_1_interfaces, {"cells": 1}, is_nonlinear=True
        )
        self.equation_system.set_equation(
            intf_adv, codim_1_interfaces, {"cells": 1}, is_nonlinear=True
        )
        self.equation_system.set_equation(
            well_eq, codim_2_interfaces, {"cells": 1}, is_nonlinear=True
        )
