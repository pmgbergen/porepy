...
solid_constants = pp.SolidConstants(
    {"permeability": 5.0e-15, "porosity": 0.2, "thermal_conductivity": 3.0, 'density': 2650.0, 'specific_heat_capacity': 1000.0}
)
...
if tracer_like_setting_q:
    ...
    brine_obl = DriesnerBrineOBL(file_name, True)
    brine_obl.conversion_factors = (1.0, 1.0, 1.0e-5)  # (z,h,p)
    model.obl = brine_obl
