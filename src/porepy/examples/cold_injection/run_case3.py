...
ModelClass._NUM_FRACTURES = 8
ModelClass._COMPONENT_NAMES = ["H2O", "H2S"]
ModelClass._IDEAL_COMPONENTS = [
    pp.compositional.ideal.IdealH2O,
    pp.compositional.ideal.IdealH2S,
]
# TODO update injected mass value.
...
ModelClass._z_INIT = {"H2O": 0.8, "H2S": 0.2}
ModelClass._z_IN = {"H2O": 0.999, "H2S": 0.001}


if __name__ == "__main__":
    timestamp = datetime.today().strftime("%d%B%Y_%H-%M-%S")
    sub_folder = f"CI_CASE3/{timestamp}"
