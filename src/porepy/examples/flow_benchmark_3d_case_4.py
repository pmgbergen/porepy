"""
This module contains the implementation of Case 4 from the 3D flow benchmark [1].
...
from porepy.applications.md_grids.mdg_library import benchmark_3d_case_4
...
class FlowBenchmark3dCase3Model(  # type:ignore[misc]
    ...
    """Mixer class for case 4 from the 3d flow benchmark."""
