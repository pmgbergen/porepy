...
from .geometry_description.geometry_market import SimpleGeometry as ModelGeometry1D
...
def saturations(self) -> dict[str, pp.ad.Operator]:
    ...
    s_l = self.vtk_sampler.sampled_cloud.point_data["S_l"]
...
class PermeabilityWithHaliteMixin(pp.PorePyModel):
    ...
    def permeability(self, subdomains: list[pp.Grid]) -> pp.ad.Operator:
        ...
        # CFF: fold the total mass mobility into the tensor (massic Darcy flux).
