...
class IC_single_phase_high_pressure(pp.PorePyModel):
...
class IC_single_phase_moderate_pressure(pp.PorePyModel):
    """See parent class how to set up BC. Default is all zero and Dirichlet."""
...
class IC_single_phase_low_pressure(pp.PorePyModel):
    """See parent class how to set up BC. Default is all zero and Dirichlet."""
...
class IC_two_phase_low_pressure(pp.PorePyModel):
    """See parent class how to set up BC. Default is all zero and Dirichlet."""
