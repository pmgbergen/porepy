...
:comparison
call python.exe ./run.py -e pT -r 0 -t 2 -s 3
call python.exe ./run.py -e ph -r 0 -t 2 -s 3
call python.exe ./run.py -e pT -r 1 -t 2 -s 3
call python.exe ./run.py -e ph -r 1 -t 2 -s 3
call python.exe ./run.py -e pT -r 2 -t 2 -s 3
call python.exe ./run.py -e ph -r 2 -t 2 -s 3
:: Run most refined cases, with pT expected to fail.
:highrefinement
call python.exe ./run.py -e ph -r 3 -t 2 -s 3
call python.exe ./run.py -e pT -r 3 -t 2 -s 3
