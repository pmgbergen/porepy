...
echo "--- SIMULATION 7 / 24 COMPLETED ---"
python3 run.py -e ph -r 0 -t 1 -s 3 -m 6
echo "--- SIMULATION 8 / 24 COMPLETED ---"
python3 run.py -e ph -r 0 -t 2 -s 3 -m 6
echo "--- SIMULATION 9 / 24 COMPLETED ---"
python3 run.py -e ph -r 0 -t 3 -s 3 -m 6
echo "--- SIMULATION 10 / 24 COMPLETED ---"
python3 run.py -e ph -r 0 -t 4 -s 3 -m 6
echo "--- SIMULATION 11 / 24 COMPLETED ---"
python3 run.py -e ph -r 0 -t 5 -s 3 -m 6
echo "--- SIMULATION 12 / 24 COMPLETED ---"
python3 run.py -e ph -r 0 -t 6 -s 3 -m 6
echo "--- SIMULATION 13 / 24 COMPLETED ---"
...
echo "--- SIMULATION 14 / 24 COMPLETED ---"
python3 run.py -e ph -r 0 -t 2 -s 3 -m 20
echo "--- SIMULATION 15 / 24 COMPLETED ---"
python3 run.py -e pT -r 1 -t 2 -s 3 -m 20
echo "--- SIMULATION 16 / 24 COMPLETED ---"
python3 run.py -e ph -r 1 -t 2 -s 3 -m 20
echo "--- SIMULATION 17 / 24 COMPLETED ---"
python3 run.py -e pT -r 2 -t 2 -s 3 -m 20
echo "--- SIMULATION 18 / 24 COMPLETED ---"
python3 run.py -e ph -r 2 -t 2 -s 3 -m 20
echo "--- SIMULATION 19 / 24 COMPLETED ---"
#Run most refined cases.
python3 run.py -e pT -r 3 -t 2 -s 3 -m 20
echo "--- SIMULATION 20 / 24 COMPLETED ---"
python3 run.py -e ph -r 3 -t 2 -s 3 -m 20
echo "--- SIMULATION 21 / 24 COMPLETED ---"
python3 run.py -e ph -r 3 -t 2 -s 3 -m 20 -L
echo "--- SIMULATION 22 / 24 COMPLETED ---"
# Run Simulation for 2D plot with time schedule
python3 run.py -p
echo "--- SIMULATION 23 / 24 COMPLETED ---"
python3 run.py -p -L
echo "--- SIMULATION 24 / 24 COMPLETED ---"
