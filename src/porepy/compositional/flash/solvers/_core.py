...
- 0: converged (success)
- 1: not converged maximal number of iterations reached
- 2: diverged (``NAN`` or ``infty`` detected in update and residual)
- 3: Reserved for failure handling in outer loop of multisolver
- 4+: Individual error codes.

Note:
    Error code 3 is generated by the multi-solver in a generic try-except clause around
