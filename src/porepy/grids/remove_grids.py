...
def remove_node(gb, node):
    ...
    for i in range(n_neighbors - 1):
        n1 = neighbors[i]
        node_index_1 = gb.has_nodes_prop([n1], 'node_index')
        print(node_index_1, 'ni1')
