...
class Exporter:
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(grid, pp.MixedDimensionalGrid):
            ...
            self.gb: pp.MixedDimensionalGrid = grid
    ...
    def _export_gb(self, data: List[str], time_step: float) -> None:
        """Export the entire MixedDimensionalGrid and additional data to vtu.

        Parameters:
            data (List[str]): Data to be exported in addition to default MixedDimensionalGrid data.
