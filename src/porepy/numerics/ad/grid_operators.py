...
class MortarProjections(Operator):
    ...
    def __init__(
        ...
        Parameters:
            gb (pp.MixedDimensionalGrid): Mixed-dimensional grid bucket.
...
class Divergence(Operator):
    ...
    def __init__(
        ...
        of the MixedDimensionalGrid iteration over grids. Iit is critical that the same ordering
        is used by other operators.
    ...
    def parse(self, gb: pp.MixedDimensionalGrid) -> sps.spmatrix:
        """Convert the Ad expression into a divergence operators on all relevant grids,
        represented as a sparse block matrix.

        Pameteres:
            gb (pp.MixedDimensionalGrid): Not used, but needed for compatibility with the general
...
class BoundaryCondition(Operator):
    ...
    def parse(self, gb: pp.MixedDimensionalGrid) -> np.ndarray:
        ...
        Pameteres:
            gb (pp.MixedDimensionalGrid): Mixed-dimensional grid. The boundary condition will be
...
class DirBC(Operator):
    ...
    def parse(self, gb: pp.MixedDimensionalGrid):
...
class ParameterArray(Operator):
    ...
    def __init__(
        ...
        in grids, or the order of the MixedDimensionalGrid iteration over grids. It is
        critical that the same ordering is used by other operators.
