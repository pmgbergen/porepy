...
class Tpsa:
    ...
    def __init__(self, keyword: str) -> None:
        ...
        # Fields related to reconstruction of 
        ...
        self.bound_displacement_rotation_cell_matrix_key: str = "bound_displacement_rotation_cell"
        self.bound_displacement_solid_pressure_cell_matrix_key: str = "bound_displacement_solid_pressure_cell"
    ...
    def discretize(self, sd: Grid, data: dict) -> None:
        ...
        stress_total_pressure = (
            filters.neu_nopass_nd @ normal_vector_diag
        ...
        # Common scaling
        sgn_area_scaling =  sps.dia_array((np.repeat(numbering.sgn_bf / sd.face_areas, numbering.nd), 0),
        ...
        # inv_mu_face).
        bound_displacement_face = filters.dir_pass_nd + sgn_area_scaling @ inv_mu_face @ (
        ...
        bound_displacement_rotation_cell = sgn_area_scaling @ inv_mu_face @(
            filters.rob_pass_nd @  stress_rotation - filters.neu_pass_nd @ Rn_hat  @ face_rotation
        )

        # Finally the contribution from the total pressure.
        bound_displacement_solid_pressure_cell = sgn_area_scaling @ inv_mu_face @(
        ...
        matrix_dictionary[self.bound_displacement_cell_matrix_key] = bound_displacement_cell
        matrix_dictionary[self.bound_displacement_face_matrix_key]  = bound_displacement_face
        matrix_dictionary[self.bound_displacement_rotation_cell_matrix_key]  = bound_displacement_rotation_cell
        matrix_dictionary[self.bound_displacement_solid_pressure_cell_matrix_key] = bound_displacement_solid_pressure_cell
    ...
    def _create_filters(
        ...
        return _BoundaryFilters(
            dir_nd, dir_nopass, dir_nopass_nd, neu_pass_nd, neu_nopass_nd, neu_rob_pass_nd, rob_nd
        )
    ...
    def _create_numbering(sd: pp.Grid):
        ...
        return _Numbering(nf, nc, nd, fi, ci, sgn, fi_expanded, ci_expanded, sgn_nd, sgn_vec)
