...
class HybridUpwind(Discretization):
    """
    - procedurally paradigm is adopted
    - I haven't specified "internal" to all the interal variables
    """

    def __init__(self, data={}, keyword: str = "transport") -> None:
        """ """
        self.keyword = keyword
        self.jacobian_V_G_matrix_key = "jac_V_G"
        self.bound_transport_neu_matrix_key = "rhs_neu"
        self.V_G_adarray = None
        self.rho_V_G_adarray = None
    ...
    def flux_V(
        ...
        def mobility_V_faces(
            ...
            mobility_upwinded = HybridUpwind.var_upwinded_faces(
    ...
    def rho_flux_V(
        ...
        rho_upwinded = HybridUpwind.var_upwinded_faces(
    ...
    def flux_G(
        ...
        for phase_id in np.arange(mixture.num_phases):
            ...
            rho = HybridUpwind.density_internal_faces(
                saturation, rho, left_restriction, right_restriction
            )  # TODO: rho used twice
            g_list[phase_id] = HybridUpwind.g_internal_faces(
    ...
    def discretize(self, sd: pp.Grid, data: dict) -> None:
        ...
        # bypass operator:
        self.V_G_adarray = rho_V_G

    # not used/to eliminate: ------------------------------------------------------------------------------------
