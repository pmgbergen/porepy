...
GridVariableTerm.grid.__doc__ = "Item in MixedDimensionalGrid. Can be node or edge."
...
class Assembler:
    ...
    def _variable_term_key(term: str, key_1: str, key_2: str, key_3: str = None) -> str:
        ...
        For nodes and internally to edges in the MixedDimensionalGrid (i.e. fixed-dimensional grids),
    ...
    def _operate_on_mdg(
        ...
        **kwargs,
        ...
        """Helper method, loop over the MixedDimensionalGrid, identify nodes / edges
    ...
    def _identify_variable_combinations(self) -> None:
        ...
        The function serves two purposes:
            1. Identify all variables and their discretizations defined on individual nodes
               and edges in the MixedDimensionalGrid
    ...
    def _local_variables(self, d: Dict) -> Dict[str, Dict[str, int]]:
        ...
        Parameters:
            d (dict): Data dictionary defined on a MixedDimensionalGrid node or edge
