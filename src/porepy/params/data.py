...
class Parameters(Dict):
    ...
    applications). The keyword assigned to parameters and discretization operators
    ensures that the right data is used: An operator will always use the parameters
    stored with under the keyword it has been assigned.
    ...
    def update_dictionaries(
        ...
        Parameters:
            keywords: list of n_phys strings addressing different physical processes.
            dictionaries: list of n_phys dictionaries with the properties to be updated.
                If not provided, empty dictionaries are used for all keywords.
        ...
        Example:
            ...
            param.update_dictionaries(keywords, dicts)
        """
    ...
    def set_from_other(
        ...
        Parameters:
            keyword_add: The keyword to whose dictionary the parameters are to be added.
            keyword_get: The keyword from whose dictionary the parameters are to be
                obtained.
            parameters: List of parameters (accessed via strings) to be set.
        """
        for p in parameters:
    ...
    def modify_parameters(
        ...
        Parameters:
            keyword: Keyword addressing the physical process.
...
def initialize_default_data(
    ...
    Parameters:
        grid: Grid to which data should be attached.
