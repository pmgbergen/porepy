...
simplex_1 = ax.plot(X1, np.zeros(len(X1)), np.zeros(len(X1)), linewidth=l, color='black')
simplex_2 = ax.plot(np.zeros(len(X1)), X1, np.zeros(len(X1)), linewidth=l, color='black')
