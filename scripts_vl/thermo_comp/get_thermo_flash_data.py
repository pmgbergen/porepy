...
if __name__ == "__main__":
    ...
    result_file_pT = f"data/thermodata_pT2k.csv"
    result_file_ph = f"data/thermodata_ph2k.csv"

    pT_identifier_file = f"data/thermodata_pT2k_id.csv"
    ph_identifier_file = f"data/thermodata_ph2k_id.csv"
    ...
    end_time = time.time()
    print(
        f"Computing thermo data: p-T data calculated after {end_time - start_time} seconds",
        flush=True,
    )
