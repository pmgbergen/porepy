...
def simplex_2d(mesh_size, a, sigma, beta, kw={}):
    ...
    mesh_kwargs = {}
    h = 1 / mesh_size
    mesh_kwargs = {"mesh_mode": "weighted", "h_ideal": h, "h_min": 1 / 2 * h}
...
def cartesian_3d(n_cells, a, sigma, t, kw={}):
    ...
    gb = pp.meshing.cart_grid(
        fracture_3d(beta, t), n_cells, **{"physdims": [1, 2 * t, 1]}
    )
    assign_parameters(gb)
...
def analytical_displacements(gb, a, sigma=1):
    ...
    normal_coordinate = g_h.face_centers[normal_ind, g_h.frac_pairs] - 0.5
...
if __name__ == "__main__":
    ...
    errors, max_errors, apertures, apertures_a = run_multiple_and_plot(
        n_cells, simplex_2d_of_nc
    )
