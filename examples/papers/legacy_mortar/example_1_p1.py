...
def solve_p1(gb, folder):
    ...
    solver_flow = p1.P1MixedDim('flow')
...
#    solve_vem(gb_ref, folder)
    ...
    for i in np.arange(N):
        ...
        cells_1d = 400 #*2**i
        cells_mortar = -4
        gb = example_1_data.create_gb(domain, cells_2d, cells_1d, cells_mortar, tol)
...
#                    Pi_ref[idx, idx] = mortars.split_matrix_1d(g_ref, g).T
#
...
#
#        error_0d = np.sqrt(error_0d/ref_0d)
#        error_1d = np.sqrt(error_1d/ref_1d)
#
#        print("error 0d", error_0d)
#        print("error 1d", error_1d)
