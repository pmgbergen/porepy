...
def define_grid():
    ...
    f_1 = np.array([[0.2, .8, .8, 0.2],
                    [.5, .5, .5, .5],
                    [.5, .5, .7, .7]])
    f_2 = np.array([[.5, .5, .5, .5],
                    [.3, .7, .7, .3],
                    [.5, .5, .7, .7]])
    f_3 = np.array([[.7, .7, .7, .7],
                    [.25, .75, .75, .25],
                    [.5, .5, .7, .7]])
    f_4 = np.array([[.3, .3, .3, .3],
                    [.25, .75, .75, .25],
                    [.5, .5, .7, .7]])
    c_1 = np.array([.35, .6, .6])
    c_5 = np.array([.35, .4, .6])
...
def sources(g):
    ...
    if g.dim == 1 and np.isclose(g.cell_centers[0, 0], .5) \
...
def evaluate_errors(p1, p2, t, t_mp, gb):
    ...
    e = [global_error(gb, p1, p2[:p1.size]), global_error(
        gb, t[-1], t_mp[-1][:p1.size])]
    return e
