...
pin100 = newp; Point(pin100) = {0.4, 0., 0., h};
pin010 = newp; Point(pin010) = {0., 0.4, 0., h};
pin001 = newp; Point(pin001) = {0., 0., 0.4, h};
pin110 = newp; Point(pin110) = {0.4, 0.4, 0., h};
pin101 = newp; Point(pin101) = {0.4, 0., 0.4, h};
pin011 = newp; Point(pin011) = {0., 0.4, 0.4, h};

pout100 = newp; Point(pout100) = {0.8, 1., 1., h};
pout010 = newp; Point(pout010) = {1., 0.8, 1., h};
pout001 = newp; Point(pout001) = {1., 1., 0.8, h};
pout110 = newp; Point(pout110) = {0.8, 0.8, 1., h};
pout101 = newp; Point(pout101) = {0.8, 1., 0.8, h};
pout011 = newp; Point(pout011) = {1., 0.8, 0.8, h};
