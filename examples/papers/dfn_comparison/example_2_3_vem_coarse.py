...
def main(id_problem, tol=1e-5, N_pts=1000, if_export=False):
    ...
    folder_export = 'example_2_3_vem_coarse_'+str(mesh_size)+'/'+str(id_problem)+"/"
    file_export = 'vem'

    gb = example_2_3_create_grid.create(id_problem, is_coarse=True,
                                        mesh_size=mesh_size, tol=tol)
