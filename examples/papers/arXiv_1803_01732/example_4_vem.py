...
grids_name = ['gb_conf_24284.grid', 'gb_conf_32614.grid', 'gb_conf_42817.grid',
              'gb_conf_64215.grid', 'gb_conf_79690.grid', 'gb_conf_112371.grid',
              \
              'gb_non_conf_19575.grid', 'gb_non_conf_53603.grid',
              'gb_non_conf_60523.grid', 'gb_non_conf_79308.grid',
              'gb_non_conf_118441.grid', 'gb_non_conf_336205.grid']
