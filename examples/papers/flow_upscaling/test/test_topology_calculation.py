...
from examples.papers.flow_upscaling.fracture_network_analysis import (
    count_node_types_between_families as top_compute,
)
...
class TestFractureSetIntersectionComputation(unittest.TestCase):
    ...
    def test_no_intersections_two_families(self):
        ...
        e_1 = np.array([[0], [1]])
        p_1 = np.array([[0, 1], [0, 0]])
        fracs_1 = self.define_set(p_1, e_1)

        e_2 = np.array([[0], [1]])
        p_2 = np.array([[0, 1], [1, 1]])
        fracs_2 = self.define_set(p_2, e_2)

        node_types_1, node_types_2 = fracture_network_analysis.analyze_intersections_of_sets(
            fracs_1, fracs_2
        )
    ...
    def test_x_intersection_two_families(self):
        e_1 = np.array([[0], [1]])
        p_1 = np.array([[-1, 1], [0, 0]])
        fracs_1 = self.define_set(p_1, e_1)

        e_2 = np.array([[0], [1]])
        p_2 = np.array([[0, 0], [-1, 1]])
        fracs_2 = self.define_set(p_2, e_2)
    ...
    def test_y_intersection_two_families(self):
        ...
        e_1 = np.array([[0], [1]])
        p_1 = np.array([[0, 2], [0, 0]])
        fracs_1 = self.define_set(p_1, e_1)

        e_2 = np.array([[0], [1]])
        p_2 = np.array([[1, 1], [0, 1]])
        fracs_2 = self.define_set(p_2, e_2)
    ...
    def test_y_intersection_two_families_flip_set_order(self):
        ...
        node_types_2, node_types_1 = fracture_network_analysis.analyze_intersections_of_sets(
            fracs_2, fracs_1
        )
